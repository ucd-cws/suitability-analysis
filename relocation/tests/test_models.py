...
class RelocationTest(TestCase):
	def test_create_relocation_town(self):
		...
		relocated.relocation_setup("Valmeyer", r"C:\Users\dsx.AD3\Code\FloodMitigation\regions\calibration_data.gdb\Valmeyer_IL_Structures_Old", r"C:\Users\dsx.AD3\Code\FloodMitigation\regions\calibration_data.gdb\Valmeyer_IL_Structures", region, True)
